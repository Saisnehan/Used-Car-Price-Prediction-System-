...
```bash
git clone https://github.com/Saisnehan/vehicle-price-prediction.git
...
mysql -u root -p
CREATE DATABASE vehicle_price_db;
EXIT;
```
...
5. View predicted price & confidence score
```
...
```
1. Upload vehicle dataset (CSV format)
2. Click "Train Models"
3. Monitor training progress
4. View results for all 5 algorithms
```
...
2. View accuracy metrics chart
3. View MAE/RMSE comparison
...
3. Deactivate/remove users if needed
```
